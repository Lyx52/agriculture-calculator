...
namespace App\Filament\Resources\User\FarmExternalService\Schemas;
...
class FarmExternalServiceForm
{
    public static function configure(Schema $schema): Schema
    {
        return $schema
            ...
            ->inlineLabel(false)
            ->components([
                TextInput::make('name')->label('Nosaukums')->required(),
                Fieldset::make()
                    ->schema([
                ...
                Hidden::make('employee_type')
                    ->default(EmployeeType::EXTERNAL_SERVICE),
            ]);
    }
}
